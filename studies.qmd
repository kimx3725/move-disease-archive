...
::: callout-tip
This table is a placeholder for studies derived from Movebank. Columns match the archive data standard. An asterisk (*) in the study name indicates datasets that were not sampled or tested for disease but involved animals found dead or alive during confirmed outbreaks in the region.
:::
...
DT::datatable(
  ...
  caption = htmltools::tags$caption(
    ...
    "Section A: Movebank-derived studies. An asterisk (*) in the study name indicates datasets that were not sampled or tested for disease but involved animals found dead or alive during confirmed outbreaks in the region."
  )
)
```
...
DT::datatable(
  ...
  caption = htmltools::tags$caption(
    style = "caption-side: bottom; text-align: left;",
    "Section B: Private Data and External Repository Data. An asterisk (*) in the study name indicates datasets that were not sampled or tested for disease but involved animals found dead or alive during confirmed outbreaks in the region."
  )
)
```