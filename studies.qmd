...
section_a_table <- tibble(
!!!setNames(rep(list(character()), length(data_columns)), data_columns)
)

new_study <- tibble(
"Study Name" = '<a href="https://doi.org/10.5441/001/1.323" target="_blank">Bobcat; Central California, USA</a>',
"Principal Investigator" = '<a href="mailto:lekserieys@gmail.com">Laurel Serieys</a>',
...
list(className = 'nowrap', targets = c(0, 7))   # 0 = Study Name, 7 = Pathogen ID
)
),
