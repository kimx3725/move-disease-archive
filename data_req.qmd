...
| Further Disease Information | String | The archive link to the disease data | repository link or Contact PI | Optional (if applicable) |
...
| Sample material | String | Organic tissue or fluid or feces being collected (e.g., liver, blood, skin, whole organism, stool). | Blood | Optional |
| Sample collection status| String | The Animal's mortality status when the samples were collected. | Alive or Dead | Required |
| Sample collection date | String | Date when the samples were collected. | YYYYMMDD | Required |
