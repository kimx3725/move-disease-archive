...
-**Build a harmonised database of animal movement and infection data**: Manage, share, and archive animal movement datasets that include disease information, diagnostic test results, and mortality outcomes. 
...
-**Provide oversight for registry database**: Clearly link animal ID and existing movement data (in any platform, MoveBank, etc.) to the health status/disease testing data
...
-**Identify additional data gaps that could be addressed with an integrated data system**: What kinds of pathogen data are not available in current research?

![](images/MDA_flow.png){fig-align="center" width="2000"}
...
Once your data are ready, please complete the [MDA Participation Agreement](participation_agreement.qmd), after which your study will be reviewed and added to the list of participating projects.
...
**Email:** [marta.valldeperes\@gmail.com](mailto:marta.valldeperes@gmail.com)
...
![](images/MDA_partners.png){fig-align="center" width="2000"}
